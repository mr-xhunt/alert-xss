const htmlCode = "<iframe src=http://bugbase-secret-file-storage.s3.ap-northeast-2.amazonaws.com/Bugbase-full-logo-black.png width=500 height=500></iframe>"; // Set the random value to send
